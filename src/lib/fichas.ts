...
export const FICHAS: Record<string, Ficha> = {
  ...
  // ------------------------------------------------------- unidad: canon --
  canonFijoActivo: {
    que: "Si hay un monto fijo a pagar por año por operar en el predio portuario.",
    paraQue: "La terminal no es dueña del suelo: le paga al concedente por el derecho a usarlo.",
    caracteristica: "Encendido o apagado.",
    impacta: "Se resta de la ganancia operativa todos los años, se mueva o no carga.",
    termino: "Canon de concesión fijo",
  },
  canonFijoMM: {
    que: "Cuánto es ese monto fijo por año.",
    paraQue: "Costear el derecho a operar, independientemente del movimiento.",
    caracteristica: "En millones de dólares por año.",
    impacta: "Baja la ganancia operativa aunque el negocio esté parado.",
  },
  canonVariableActivo: {
    que: "Si además se paga un monto por cada tonelada movida.",
  ...
  canonVariable: {
    que: "Cuánto se paga por cada tonelada que pasa por la terminal.",
    paraQue: "Costear el derecho de uso en función del movimiento real.",
    caracteristica: "En dólares por tonelada.",
    impacta: "Reduce el margen de cada tonelada.",
  },
  canonPctActivo: {
    que: "Si se paga además un porcentaje de lo facturado.",
  ...
  canonPct: {
    ...
    caracteristica: "Un porcentaje sobre la facturación bruta del negocio.",
